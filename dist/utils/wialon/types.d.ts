import { CoreSearchItemsParams, CoreSearchItemParams, CoreSearchItemResponse, ItemUpdateProfileFieldParams, UnitGetVinInfoParams, MessagesDeleteMessageParams, MessagesLoadIntervalParams, TokenLoginParams, CoreSearchItemsResponse, ItemUpdateProfileFieldResponse, UnitGetVinInfoResponse, MessagesDeleteMessageResponse, MessagesLoadIntervalResponse, TokenLoginResponse, UnitUpdateServiceIntervalParams, UnitUpdateServiceIntervalResponse } from "./";
...
export declare type SVC = string | "token/login" | "core/search_items" | "core/search_item" | "messages/load_interval" | "messages/delete_message" | "core/batch" | "unit/get_vin_info" | "item/update_profile_field" | "unit/update_service_interval";
