...
interface CreateParams extends BaseParams {
    p: {
        ...
        criterions: { max_late: null | number } | null;
    };
    /** Order name */
    n: string;
...
type GeneralResponse<T> = [number, T];
...
export type Params<CallModeKey extends CallMode> = CallModeKey extends Extract<
    CallMode,
    "create" | "update"
>
    ? CreateParams
    : CallModeKey extends Extract<CallMode, "assign">
    ? AssignParams
    : BaseParams;
...
export type Response<
    CallModeKey extends CallMode
    > = CallModeResponse[CallModeKey];
